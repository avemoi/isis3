...
########################################################################################################################3
    ...
    def outputButtonClicked(self):
        ...
        #filename=QtGui.QFileDialog.getExistingDirectory(parent=None, caption='', directory='')
    ...
    def action_Run_Clicked(self):
        ...
        #input_cub_path    = "/home/enos/workspace/Despeckle_filter/source/data/T19_crop.cub"
        #output_cub_path   = "/home/enos/Desktop"
        #input_kernel_path = "/home/enos/workspace/Despeckle_filter/source/kernel/mykern.txt"
        #l_value           = "0.08"
        #iterations        = "5"
